...
class SteeringModesCluster(QWidget):
    ...
    def __init__(self, robot, parent=None):
        ...
        self.on_point_steering_button = QPushButton("On-Point", self)
        ...
        self.fused_steering_button = QPushButton("Fused", self)
        ...
        self.tank_steering_button = QPushButton("Tank", self)
